...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `notes` (`timestamp`, `srno`, `title`,`year`, `mproject`,`description`, `tname`, `tinfo`, `gname`, `pdf`,`certificate`,`report`, `link`) VALUES 
(current_timestamp(), NULL, '$title' ,'$year','$mproject', '$desc', '$tname','$tinfo', '$gname', '$pdf','$certificate','$report','$link')";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container my-5">
                            ...
                            <form action="../subpages/_aids.php" method="post">
                                <div class="form-group main ">
                                    <label for="title"> Project Name</label>
                                    <input type="text" class="form-control" id="title" name="title" aria-describedby="emailHelp">
                                </div>
                                <div class="form-group">
                                    <label for="mproject">Miniproject/Megaproject</label>
                                    <input type="text" class="form-control" id="mproject" name="mproject" aria-describedby="emailHelp">
                                </div>
                                 <div class="form-group">
